...
import { submitUserResponses } from './workerFunctions/submitUserResponses';
...
class FormContainer extends Component {
  ...
  render() {
    return (
      <form onSubmit={e => submitUserResponses(e, this.state.userAccept, this.state.userRating, this.state.zipcode)}>
